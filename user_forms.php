...
<div id="form-background">
    ...
    <h2>Add a new user</h2>
            ...
            <div class="label-and-input">
                ...
                <input type="text" id="acc-uname" name="uname" class="new-user-input" required>
            </div>
            <div class="label-and-input">
                <label for="pwd"> Password:</label>
                <input type="password" id="acc-pwd" name="pwd" class="new-user-input" required>
            </div>
            <div class="label-and-input">
                <label for="con-pwd">Confirm Password:</label>
                <input type="password" id="acc-con-pwd" name="con-pwd" class="new-user-input" required>
            </div>
...
<input name="change-pwd" type="password" id="change-pwd-input" class="new-pwd-input" required>
</div>
<div class="label-and-input">
<label for="con-change-pwd">Confirm password</label>
<input name="con-change-pwd" type="password" id="con-change-pwd-input" class="new-pwd-input" required>
</div>
<div>
